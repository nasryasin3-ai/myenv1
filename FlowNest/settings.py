...
MIDDLEWARE = [
    ...
    'FlowNest.middleware.DynamicSessionMiddleware',
    'django.middleware.locale.LocaleMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'FlowNest.middleware.ApprovalMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'FlowNest.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'FlowNest.context_processors.global_sidebar_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'FlowNest.wsgi.application'
...
if EMAIL_HOST_USER:
    ...
    EMAIL_FILE_PATH = os.path.join(PERSISTENT_DATA_DIR, 'reset_emails')
...
# Set cache directories explicitly without overriding HOME
os.environ['HF_HOME'] = str(_AI_CACHE_DIR / 'huggingface')
os.environ['CHROMA_CACHE_DIR'] = str(_AI_CACHE_DIR / 'chroma')
